...
LineFollowing::LineFollowing() {
  ...
  lower_red[0] = 126; //183; //188; //165; //177; //200; //245; //287; //229; //150; //266; //229;
  lower_red[1] = 74; //99; //81; //82; //85; //100; //130; //180; //142; //100; //162; //149;
  lower_red[2] = 45; //82; //51; //62; //67; //80; //104; //149; //119; //100; // 118; //130;
  lower_red[3] = 32; //58; //41; //61; //51; //60; //89; //151; //125; //100; //117; //136;

  upper_red[0] = 370; //427; //423; //500; //581; //650; //699; //675; //600; //650; //726; //543; //550;//776; //679;
  upper_red[1] = 239; //237; //233; //280; //320; //350; //397; //430; //550; //600; //640; //377; //300;//483; //460;
  upper_red[2] = 214; //211; //191; //200; //257; //260; //307; //359; //440; //480; //540; //317; //300;//369; //394;
  upper_red[3] = 266; //246; //167; //170; //201; //230; //264; //352; //440; //480; //539; //351; //300;//371; //415;
